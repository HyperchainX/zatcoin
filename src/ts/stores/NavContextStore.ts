...
export class NavContextStore extends StoreBase {
    ...
    navigateToTodoList(selectedTodoId?: string, showNewTodoPanel = false,showHomePanel = false,  showSwap = false,showAbout=false,showRoad=false,showInvolve=false,showPartner=false,showICO=false,showTerms=false,showChat=false,showChats=false,showRecharge=false,showStripe=false) {
        this.setNavContext(NavActions.createTodoListContext(this._isUsingStackNav, selectedTodoId, showNewTodoPanel, showHomePanel,  showSwap,showAbout,showRoad,showInvolve,showPartner,showICO,showTerms,showChat,showChats,showRecharge,showStripe));
    }
