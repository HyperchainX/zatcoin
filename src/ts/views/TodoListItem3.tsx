...
export default class TodoListItem3 extends ComponentBase<TodoListItemProps, TodoListItemState> {
    ...
    private _onPress = (e: RX.Types.SyntheticEvent) => {
        ...
        console.log(this.props.todo.type)

        console.log(this.props.todo.description)
        console.log(this.props.todo.forSale)
        console.log(this.props.todo.name)
        console.log(this.props.todo.ownerEmail)
        console.log(this.props.todo.price)
        console.log(this.props.todo.uri)
        ...
        return (
            <RX.View style={buttonStyles}>
                ...
                {this.props.todo.type === 'video' ? <VideoPlayer
                    ...
                    : null}
                {nameText}
                <RX.Text style={[_styles.todoNameText, { marginLeft: 50 }]} numberOfLines={1}>
                    {this.props.todo.price + ' Csb'}
                </RX.Text>
            </RX.View>
        );
    };
