...
export default class SimpleMenu3 extends ComponentBase<MenuProps, MenuState> {
    ...
    render() {
        ...
        return (
            <RX.View style={[_styles.menuContainer, { width: this.state.width * 0.15 }]} onKeyPress={this._onKeyPress}>
                {menuItems}
            </RX.View>
        );
    }
